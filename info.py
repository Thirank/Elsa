...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://TKT:TKT@cluster0.yly8xld.mongodb.net/?retryWrites=true&w=majority")
...
S_GROUP = environ.get('S_GROUP',"https://t.me/Mc_group_films")
MAIN_CHANNEL = environ.get('MAIN_CHANNEL',"https://t.me/Mc_Films_Update")
#Must change this link to work redirect (FILE_FORWORD)
FILE_FORWARD = environ.get('FILE_FORWARD',"")
MSG_ALRT = environ.get('MSG_ALRT', '𝑪𝑯𝑬𝑪𝑲 & 𝑻𝑹𝒀 𝑨𝑳𝑳 𝑴𝒀 𝑭𝑬𝑨𝑻𝑼𝑹𝑬𝑺')
FILE_CHANNEL = int(environ.get('FILE_CHANNEL', 0))
LOG_CHANNEL = int(environ.get('LOG_CHANNEL',  -1001868048359))
